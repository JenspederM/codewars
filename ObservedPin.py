...
def get_pins(observed):
    ...
    * possible in sense of: the observed PIN itself and all variations
    ...
    for tup in expectations:
      test.assert_equals(sorted(get_pins(tup[0])), sorted(tup[1]), 'PIN: ' +
      tup[0])
    """
    key_dict = {
        '0': ['8'],
    ...
    obs = [[key] + key_dict[key] for key in observed]
    return [''.join(p) for p in product(*obs)]
...
expectations = [('8', ['5', '7', '8', '9', '0']),
                ...
                ('369',
                 ["339", "366", "399", "658", "636", "258", "268", "669", "668",
                  ...
                  "696", "269", "358", "656", "698", "699", "298", "236",
                  "239"])]


    for tup in [expectations[2]]:
        print(f'{sorted(get_pins(tup[0]))}\n'
              f'{sorted(tup[1])}\n'
              f'PIN: {tup[0]}')
"""
